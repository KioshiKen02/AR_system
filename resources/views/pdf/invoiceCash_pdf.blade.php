    ...
    <table class="document-table-two">
        <tbody>
            ...
            <tr>
                <td>VAT</td>
                <td class="amount">
                    @if (!empty($data['addVat']) && empty($data['deductVat']))
                        {{ number_format($data['addVat'], 2) }}
                    @elseif(!empty($data['deductVat']))
                        {{ number_format($data['deductVat'], 2) }}
                    @else
                        0.00
                    @endif
                </td>
            ...
            <tr>
                ...
                <td class="amount"><strong>
                        {{ number_format($data['netTotal'] ?? 0, 2) }}</strong></td>
            </tr>
        </tbody>
    </table>
