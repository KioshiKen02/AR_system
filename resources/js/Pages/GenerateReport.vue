<template>
    <div>
        ...
        >
            <InvoiceProoflist
                v-if="showInvoiceProoflist"
                :show="showInvoiceProoflist"
        ...
        >
            <InvoiceSummary
                v-if="showInvoiceSummarylist"
                :show="showInvoiceSummarylist"
        ...
        >
            <AdjustmentProoflist
                v-if="showAdjustmentProoflist"
                :show="showAdjustmentProoflist"
        ...
        >
            <PaymentProoflist
                v-if="showPaymentProoflistDetailed"
                :show="showPaymentProoflistDetailed"
                :type="'DETAILED'"
                @close="showPaymentProoflistDetailed = false"
            />
        </Transition>
        <Transition
            enter-active-class="transition ease-out duration-300"
        ...
        >
            <PaymentProoflist
                v-if="showPaymentProoflistSummary"
                :show="showPaymentProoflistSummary"
                :type="'SUMMARY'"
        ...
        >
            <CustomerPDCReport
                v-if="showCustomerPDCReport"
                :show="showCustomerPDCReport"
        ...
        >
            <CustomerARAging
                v-if="showCustomerARAging"
                :show="showCustomerARAging"
        ...
        >
            <BegBalProoflist
                v-if="showBegBalProoflist"
                :show="showBegBalProoflist"
        ...
        <Transition
            ...
            leave-to-class="opacity-0 scale-95"
        >
            <AROutstandingBalanceAO
                v-if="showAROutstandingBalanceAO"
                :show="showAROutstandingBalanceAO"
        ...
        <Transition
            ...
            leave-to-class="opacity-0 scale-95"
        >
            <AROutstandingBalanceDR
                v-if="showAROutstandingBalanceDR"
                :show="showAROutstandingBalanceDR"
        ...
        >
            <SalesPerItem
                v-if="showSalesPerItem"
                :show="showSalesPerItem"
                @close="showSalesPerItem = false"
            />
        </Transition>
        <Transition
            enter-active-class="transition ease-out duration-300"
        ...
        >
            <OverageShortage
                v-if="showOverageShortage"
                :show="showOverageShortage"
        ...
        >
            <StatementOfAccountSummary
                v-if="showStatementOfAccountSummary"
                :show="showStatementOfAccountSummary"
                ...
                >
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <ReportButton
                                icon="credit-card"
                                title="Payment Prooflist (Detailed)"
                                @click="showPaymentProoflistDetailed = true"
                            />
                            <ReportButton
                                icon="credit-card"
                                title="Payment Prooflist (Summary)"
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <ReportButton
                                icon="clock"
                                title="AR Aging"
                                @click="handleCustomerAgingReport('AR')"
                            />
                            <ReportButton
                                icon="banknotes"
                                title="PDC - DC"
                                @click="handleCustomerAgingReport('PDC')"
                            />
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <ReportButton
                                icon="scale"
                                title="Beginning Balance Prooflist"
                    ...
                    <!-- Billing of Statements and Other Charges Report Card -->
                    <div
                    ...
                    >
                        ...
                        >
                            <svg-icon
                                ...
                                class="w-5 h-5 text-[var(--color-primary)]"
                            />
                            Billing of Statements and Other Charges Report
                        </h3>
