<template>
    <div>
        ...
        <div class="flex justify-between pb-3 pt-1">
            <button
                :disabled="!canInsert('0402-WHTCLR')"
                @click="openModal()"
        ...
        >
            ...
            >
                ...
                <tbody v-else>
                    <tr
                        v-for="wht_clearing in wht_clearings.data"
                        :key="wht_clearing.id"
                        class="hover:bg-[var(--color-primary)]/20 transition-colors duration-150 group h-10"
                    >
                        <td class="px-3 py-1 font-medium">
                            {{ wht_clearing.wht_clearing_no }}
                        </td>
                        <td class="px-3 py-1">
                            {{ formatDate(wht_clearing.transaction_date) }}
                        </td>
                        <td class="px-3 py-1">
                            {{ formatDate(wht_clearing.clearing_date) }}
                        </td>
                        <td class="px-3 py-1 font-medium">
                        ...
                        <td class="px-3 py-1">
                            <div class="flex justify-center gap-2">
                                <button
                                    @click="openViewModal(wht_clearing)"
                    ...
                    <!-- Empty State -->
                    <tr v-if="!isLoading && wht_clearings.data.length === 0">
            ...
            <!-- Pagination Links -->
            <div v-if="isLoading || wht_clearings.data.length === 0" />
            <div v-else>
                <PaginationLinks :paginator="wht_clearings" />
            </div>
        </div>
    </div>
</template>
...
import ViewWHTClearing from "../Modals/UtilityModals/ViewWHTClearing.vue";
