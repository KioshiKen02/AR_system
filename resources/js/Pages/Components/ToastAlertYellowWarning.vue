<template>
    <transition name="fade-wobble" mode="out-in">
        <div
            v-if="show"
            class="fixed top-5 left-1/2 transform -translate-x-1/2 bg-yellow-600 text-white px-4 py-3 rounded-md shadow-lg shadow-[#131313a2] z-[9999] w-auto min-w-[250px] max-w-[90vw]"
        >
            <div class="flex items-center justify-center">
                ...
                <span>{{ message }}</span>
                <div
                    class="h-1 bg-white/60 absolute bottom-0 left-0 rounded-bl-md rounded-br-md"
