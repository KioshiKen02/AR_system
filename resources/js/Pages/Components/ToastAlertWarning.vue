<template>
    <transition name="fade-wobble" mode="out-in">
        <div
            v-if="show"
            class="fixed top-5 left-1/2 transform -translate-x-1/2 bg-red-600 text-white px-4 py-3 rounded-md shadow-lg shadow-[#131313a2] z-[9999] w-auto min-w-[250px] max-w-[90vw]"
        >
