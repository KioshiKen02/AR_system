...
watch(
    ...
    async (visible, oldVisible) => {
        if (visible && !oldVisible) {
            ...
            form.wht_clearing_no = props.selected?.wht_clearing_no || null;
            ...
            try {
                ...
                if (!props.selected?.wht_clearing_no) {
                    console.error("WHT Clearing Number is missing in selected props");
                ...
                } else if (response.data?.wht_details && Array.isArray(response.data.wht_details)) {
                    rawData = response.data.wht_details;
                ...
                paymentDetails.value = rawData.map((payment) => ({
                    ...
                    wht_no: payment.wht_no || payment.check_no || "N/A",
                    document_no: payment.document_no || "N/A",
                    receipt_date: payment.receipt_date || payment.payment_receipt_date || payment.payment_date || payment.document_date || null,
