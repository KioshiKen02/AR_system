            ...
            <form @submit.prevent="submit">
                <div class="px-8 py-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <!-- Date Type Selection -->
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-lg font-bold">DATE TYPE</label>
                            <div class="flex gap-4">
                                <label class="inline-flex items-center cursor-pointer group">
                                    <input type="radio" v-model="form.date_type" value="Payment Date"
                                        class="hidden peer" />
                                    <div class="relative flex items-center justify-center p-2">
                                        <!-- Hover circle -->
                                        <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
                                        ...
                                        <span class="text-sm font-medium z-10">Payment Date</span>
                                    </div>
                                </label>
                            </div>
                        </div>
...
<script setup>
    ...
    const submit = () => {
        ...
        form.post(route("pdcDcReport", { tenant: page.props.tenant }), {
            onSuccess: () => {
