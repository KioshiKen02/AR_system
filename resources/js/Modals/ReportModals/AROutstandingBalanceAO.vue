                ...
                <div class="px-8 py-6">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-bold">GENERATE AS</label>
                        ...
                        <div v-if="form.customer_type === 'By Customer'" class="grid grid-cols-3 gap-2">
                        ...
                        <div v-if="form.customer_type === 'All Customer'" class="flex flex-col gap-2">
                            <!-- Report Options -->
                            <div class="flex flex-col gap-2">
                                <label class="block text-sm font-medium text-[var(--color-text-secondary)]">Select
                                    Customer Type</label>
                                <div class="w-full grid grid-cols-3 grid-rows-auto gap-4">
                                    <!-- Booking -->
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.customerOptions.booking
                                            " :class="('',
                                        ...
                                        <span class="ml-2 text-sm font-medium">Booking</span>
                                    </label>

                                    <!-- Concession -->
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.customerOptions.concession
                                            " :class="('',
                                                    form.errors.customerOptions
                                                        ? 'peer appearance-none w-5 h-5 border-2 border-red-400 rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200'
                                                        : 'peer appearance-none w-5 h-5 border-2 border-[var(--color-border)] rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200')
                                        ...
                                        <span class="ml-2 text-sm font-medium">Concession</span>
                                    </label>

                                    <!-- External -->
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.customerOptions.external
                                            " :class="('',
                                                    form.errors.customerOptions
                                                        ? 'peer appearance-none w-5 h-5 border-2 border-red-400 rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200'
                                                        : 'peer appearance-none w-5 h-5 border-2 border-[var(--color-border)] rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200')
                                        ...
                                        <span class="ml-2 text-sm font-medium">External</span>
                                    </label>

                                    <!-- Internal -->
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.customerOptions.internal
                                            " :class="('',
                                                    form.errors.customerOptions
                                                        ? 'peer appearance-none w-5 h-5 border-2 border-red-400 rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200'
                                                        : 'peer appearance-none w-5 h-5 border-2 border-[var(--color-border)] rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200')
                                        ...
                                        <span class="ml-2 text-sm font-medium">Internal</span>
                                    </label>

                                    <!-- Nico Employees -->
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.customerOptions
                                                .nicoEmployees
                                            " :class="('',
                                                    form.errors.customerOptions
                                                        ? 'peer appearance-none w-5 h-5 border-2 border-red-400 rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200'
                                        ...
                                        <span class="ml-2 text-sm font-medium">Nico Employees</span>
                                    </label>

                                    <!-- Subsidiary -->
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.customerOptions.subsidiary
                                            " :class="('',
                                                    form.errors.customerOptions
                                                        ? 'peer appearance-none w-5 h-5 border-2 border-red-400 rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200'
                                                        : 'peer appearance-none w-5 h-5 border-2 border-[var(--color-border)] rounded-md checked:bg-[var(--color-bg-avatar)] checked:border-transparent focus:outline-none transition-colors duration-200')
                                        ...
                                        <span class="ml-2 text-sm font-medium">Subsidiary</span>
                                    </label>
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="ml-2 text-sm font-medium">Institutional</span>
                                    </label>
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="ml-2 text-sm font-medium">Alturas Employees</span>
                                    </label>
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="ml-2 text-sm font-medium">Easy Link Employees</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="block text-md font-bold">AS OF DATE</label>
                            <!-- Date Range -->
                            <div class="grid grid-cols-2 gap-2">
                                <div class="space-y-1">
                                    <label
                                        class="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">Select
                                        a Date</label>
                                    <DatePicker v-model="form.as_of_date" placeholder="Select Date" format="MM-DD-YYYY"
...
<script setup>
    ...
    const submit = () => {
        ...
        form.post(route("arOutstandingBalanceAO", { tenant: page.props.tenant }), {
            onSuccess: () => {
