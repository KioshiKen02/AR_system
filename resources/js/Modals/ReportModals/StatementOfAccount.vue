                ...
                <div class="px-8 py-6">
                    ...
                    <div class="px-8 pb-4">
                        <h2 class="text-2xl font-bold text-center">
                            BILLING OF STATEMENTS AND OTHER CHARGES
                            {{ props.type === "SOA" ? "" : "(DFC)" }}
                        </h2>
                        <div
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <!-- Date Type Selection -->
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-lg font-bold">PERIOD COVERED</label>
                        </div>
                            ...
                            <div class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                                ...
                                <label class="w-full inline-flex items-center cursor-pointer group">
                                    ...
                                    <div class="w-full relative flex items-center justify-start p-2">
                                        ...
                                        <span class="text-sm font-medium z-10">Sales Invoice</span>
                                    </div>
                                </label>

                                <!-- By Charge Invoice Option -->
                                <label class="w-full inline-flex items-center cursor-pointer group">
                                    <input type="radio" v-model="form.type" value="Charge Invoice"
                                        class="hidden peer" />
                                    <div class="w-full relative flex items-center justify-start p-2">
                                        <!-- Hover circle -->
                                        <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
...
w-2.5 h-2.5 rounded-full bg-[var(--color-border)] transition-opacity"
                                ...
                                <!-- By Payment Option -->
                                <label class="w-full inline-flex items-center cursor-pointer group">
                                    <input type="radio" v-model="form.type" value="Payment" class="hidden peer" />
                                    <div class="w-full relative flex items-center justify-start p-2">
                                        <!-- Hover circle -->
                                        <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
                                            :class="{
                                ...
                                <!-- By BG Option -->
                                <label class="w-full inline-flex items-center cursor-pointer group">
                                    <input type="radio" v-model="form.type" value="BG" class="hidden peer" />
                                    <div class="w-full relative flex items-center justify-start p-2">
                                        <!-- Hover circle -->
                                        <div class="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--color-border)]/40"
                                            :class="{
                                        ...
                                        <span class="text-sm font-medium z-10">Beginning Balance</span>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- Date Type Selection -->
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-lg font-bold">STATEMENT DATE</label>
                        </div>

                        <!-- Date Range -->
                        <div class="grid grid-cols-2 gap-2">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">Select
                                    a Date</label>
                                <DatePicker v-model="form.statement_date" placeholder="Select Date" format="MM-DD-YYYY"
