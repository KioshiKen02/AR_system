            ...
            <form @submit.prevent="submit">
                <div class="px-8 py-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <!-- Date Type Selection -->
                        <div class="flex flex-col gap-2">
                            <label class="block text-md font-lg font-bold">AS OF DATE</label>
                        </div>
...
<script setup>
    ...
    const previewInvoice = async () => {
        try {
            ...
            apiRoute.value = "customerArAging";
    ...
    const submit = () => {
        ...
        form.post(route("customerArAging", { tenant: page.props.tenant }), {
            onSuccess: () => {
