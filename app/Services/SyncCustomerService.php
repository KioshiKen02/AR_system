    ...
    public function sync()
    {
        try {
            ...
            switch ($appName) {
                ...
                // ubay server 
                case 'Feedmill':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=19';
                    break;
                case 'Growout':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=20';
                    break;
                case 'Cortes Fertilizer':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=42';
                    break;
                case 'Ubay Fertilizer':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=22';
                    break;
                case 'Piggery Untaga':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=23';
                    break;
                case 'Demo Farm':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=21';
                    break;
                case 'Dressing Plant':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=17';
                    break;
                case 'Farmers Market':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=41';
                    break;
                case 'Meat Processing':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=46';
                    break;
                case 'Rendering':
                    $baseUrl = 'http://172.16.105.1:81/centralized-invoicing/masterfileController/CustomerController/fetchCustomers?noSession=true&bu=18';
                    break;
                default:
